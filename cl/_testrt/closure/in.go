...
// CHECK-LINE: @0 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
// CHECK-LINE: @1 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
...
// CHECK-LABEL: define void @"{{.*}}/cl/_testrt/closure.init"(){{.*}} {
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %0 = load i1, ptr @"{{.*}}/cl/_testrt/closure.init$guard", align 1
// CHECK-NEXT:   br i1 %0, label %_llgo_2, label %_llgo_1
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_1:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store i1 true, ptr @"{{.*}}/cl/_testrt/closure.init$guard", align 1
...
// CHECK-NEXT:   store { ptr, ptr } { ptr @"__llgo_stub.{{.*}}/cl/_testrt/closure.main$2", ptr null }, ptr %0, align 8
...
// CHECK-LABEL: define linkonce void @"__llgo_stub.{{.*}}/cl/_testrt/closure.main$2"(ptr %0, i64 %1, i64 %2){{.*}} {
// CHECK-NEXT: _llgo_0:
