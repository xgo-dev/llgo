...
// CHECK-NEXT: call void %__llgo_funcval_code(ptr {{(nest|swiftself)}} [[FN2_DATA]])
func main() {
	...
	// CHECK-NEXT: call void %__llgo_funcval_code(ptr {{(nest|swiftself)}} [[CAPTURED_FN1_ENV]], i64 100, i64 200)
	fn2 := func() {
		fn1(100, 200)
	}
	fn2()
