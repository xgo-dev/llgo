...
// CHECK-LINE: @2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1

// CHECK-LABEL: define { ptr, ptr } @"{{.*}}/cl/_testrt/result.add"(){{.*}} {
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   ret { ptr, ptr } { ptr @"__llgo_stub.{{.*}}/cl/_testrt/result.add$1", ptr null }
// CHECK-NEXT: }
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   ret { { ptr, ptr }, i64 } { { ptr, ptr } { ptr @"__llgo_stub.{{.*}}/cl/_testrt/result.add2$1", ptr null }, i64 1 }
// CHECK-NEXT: }
...
// CHECK-LABEL: define void @"{{.*}}/cl/_testrt/result.init"(){{.*}} {
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %0 = load i1, ptr @"{{.*}}/cl/_testrt/result.init$guard", align 1
// CHECK-NEXT:   br i1 %0, label %_llgo_2, label %_llgo_1
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_1:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store i1 true, ptr @"{{.*}}/cl/_testrt/result.init$guard", align 1
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   ret { ptr, ptr } { ptr @"__llgo_stub.{{.*}}/cl/_testrt/result.main$1$1", ptr null }
// CHECK-NEXT: }
...
// CHECK-LABEL: define linkonce i64 @"__llgo_stub.{{.*}}/cl/_testrt/result.add$1"(ptr %0, i64 %1, i64 %2){{.*}} {
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %3 = tail call i64 @"{{.*}}/cl/_testrt/result.add$1"(i64 %1, i64 %2)
// CHECK-NEXT:   ret i64 %3
// CHECK-NEXT: }

// CHECK-LABEL: define linkonce i64 @"__llgo_stub.{{.*}}/cl/_testrt/result.add2$1"(ptr %0, i64 %1, i64 %2){{.*}} {
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %3 = tail call i64 @"{{.*}}/cl/_testrt/result.add2$1"(i64 %1, i64 %2)
// CHECK-NEXT:   ret i64 %3
// CHECK-NEXT: }

// CHECK-LABEL: define linkonce i64 @"__llgo_stub.{{.*}}/cl/_testrt/result.main$1$1"(ptr %0, i64 %1, i64 %2){{.*}} {
// CHECK-NEXT: _llgo_0:
