...
// CHECK-NEXT:   %2 = getelementptr inbounds %"{{.*}}/cl/_testrt/struct.Foo", ptr %0, i32 0, i32 0
// CHECK-NEXT:   %3 = icmp eq ptr %0, null
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.AssertNilDeref"(i1 %3)
// CHECK-NEXT:   %4 = getelementptr inbounds %"{{.*}}/cl/_testrt/struct.Foo", ptr %0, i32 0, i32 1
// CHECK-NEXT:   store i32 100, ptr %2, align 4
// CHECK-NEXT:   store i1 true, ptr %4, align 1
// CHECK-NEXT:   %5 = load %"{{.*}}/cl/_testrt/struct.Foo", ptr %0, align 4
// CHECK-NEXT:   call void @"{{.*}}/cl/_testrt/struct.Foo.Print"(%"{{.*}}/cl/_testrt/struct.Foo" %5)
// CHECK-NEXT:   ret void
// CHECK-NEXT: }
