...
// CHECK-LABEL: define void @"{{.*}}/cl/_testrt/freevars.init"(){{.*}} {
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %0 = load i1, ptr @"{{.*}}/cl/_testrt/freevars.init$guard", align 1
// CHECK-NEXT:   br i1 %0, label %_llgo_2, label %_llgo_1
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_1:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store i1 true, ptr @"{{.*}}/cl/_testrt/freevars.init$guard", align 1
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   call void @"{{.*}}/cl/_testrt/freevars.main$1"({ ptr, ptr } { ptr @"__llgo_stub.{{.*}}/cl/_testrt/freevars.main$2", ptr null })
// CHECK-NEXT:   ret void
// CHECK-NEXT: }
...
// CHECK-LABEL: define linkonce void @"__llgo_stub.{{.*}}/cl/_testrt/freevars.main$2"(ptr %0, %"{{.*}}/runtime/internal/runtime.iface" %1){{.*}} {
// CHECK-NEXT: _llgo_0:
