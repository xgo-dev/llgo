...
// CHECK-NEXT:   %2 = load ptr, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_cos", align 8
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_free", align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_log", align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
// CHECK-NEXT:   %4 = call double %3(double %0)
// CHECK-NEXT:   ret double %4
// CHECK-NEXT: }
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_puts", align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_sin", align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
// CHECK-NEXT:   %4 = call double %3(double %0)
// CHECK-NEXT:   ret double %4
// CHECK-NEXT: }
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_sqrt", align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
// CHECK-NEXT:   %4 = call double %3(double %0)
// CHECK-NEXT:   ret double %4
// CHECK-NEXT: }
...
// CHECK-NEXT:   store ptr @_cgo_f32e6c736a37_Cfunc_cos, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_cos", align 8
// CHECK-NEXT:   store ptr @_cgo_f32e6c736a37_Cfunc_free, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_free", align 8
// CHECK-NEXT:   store ptr @_cgo_f32e6c736a37_Cfunc_log, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_log", align 8
// CHECK-NEXT:   store ptr @_cgo_f32e6c736a37_Cfunc_puts, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_puts", align 8
// CHECK-NEXT:   store ptr @_cgo_f32e6c736a37_Cfunc_sin, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_sin", align 8
// CHECK-NEXT:   store ptr @_cgo_f32e6c736a37_Cfunc_sqrt, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc_sqrt", align 8
// CHECK-NEXT:   store ptr @_cgo_f32e6c736a37_Cfunc__Cmalloc, ptr @"{{.*}}/cl/_testgo/cgobasic._cgo_f32e6c736a37_Cfunc__Cmalloc", align 8
