...
// ARM64-NEXT: [[C_RESULT:%[0-9]+]] = call i32 %__llgo_funcval_code(ptr swiftself [[C_ENV]], i32 %1)
// AMD64-NEXT: [[C_RESULT:%[0-9]+]] = call i32 %__llgo_funcval_code(ptr nest [[C_ENV]], i32 %1)
...
// ARM64: call i64 [[NO_FREE_CODE]](ptr swiftself [[NO_FREE_ENV]], i64 1)
// AMD64: call i64 [[NO_FREE_CODE]](ptr nest [[NO_FREE_ENV]], i64 1)
...
// ARM64: call i64 [[WITH_FREE_CODE]](ptr swiftself [[WITH_FREE_ENV]], i64 2)
// AMD64: call i64 [[WITH_FREE_CODE]](ptr nest [[WITH_FREE_ENV]], i64 2)
...
// ARM64: call i64 [[METHOD_CODE]](ptr swiftself [[METHOD_CALL_ENV]], i64 7)
// AMD64: call i64 [[METHOD_CODE]](ptr nest [[METHOD_CALL_ENV]], i64 7)
...
// ARM64: call i64 [[IFACE_CODE]](ptr swiftself [[IFACE_CALL_ENV]], i64 9)
// AMD64: call i64 [[IFACE_CODE]](ptr nest [[IFACE_CALL_ENV]], i64 9)
...
// ARM64-LABEL: define i64 @"main.makeWithFree$1"(ptr swiftself %0, i64 %1){{.*}} {
// AMD64-LABEL: define i64 @"main.makeWithFree$1"(ptr nest %0, i64 %1){{.*}} {
...
// ARM64-LABEL: define i64 @"main.(*S).Add$bound"(ptr swiftself %0, i64 %1){{.*}} {
// AMD64-LABEL: define i64 @"main.(*S).Add$bound"(ptr nest %0, i64 %1){{.*}} {
...
// ARM64-LABEL: define i64 @"main.interface{Add(int) int}.Add$bound"(ptr swiftself %0, i64 %1){{.*}} {
// AMD64-LABEL: define i64 @"main.interface{Add(int) int}.Add$bound"(ptr nest %0, i64 %1){{.*}} {
