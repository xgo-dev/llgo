...
// CHECK-NEXT:   call void @"{{.*}}/cl/_testgo/runextest/bar.init"()
// CHECK-NEXT:   call void @"{{.*}}/cl/_testgo/runextest/foo.init"()
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %0 = call i64 @"{{.*}}/cl/_testgo/runextest/foo.Foo"()
...
// CHECK-NEXT:   %1 = call i64 @"{{.*}}/cl/_testgo/runextest/bar.Bar"()
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.PrintString"(%"{{.*}}/runtime/internal/runtime.String" { ptr @{{[0-9]+}}, i64 9 })
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.PrintByte"(i8 32)
