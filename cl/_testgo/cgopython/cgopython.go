...
// CHECK-NEXT:   %3 = call ptr @llvm.frameaddress.p0(i32 0)
// CHECK-NEXT:   %4 = call ptr @"{{.*}}/runtime/internal/runtime.AllocU"(i64 56)
// CHECK-NEXT:   %5 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 0
// CHECK-NEXT:   store ptr %2, ptr %5, align 8
...
// CHECK-NEXT:   store ptr %1, ptr %7, align 8
// CHECK-NEXT:   %8 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 3
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgopython.main", %_llgo_2), ptr %8, align 8
// CHECK-NEXT:   %9 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 4
// CHECK-NEXT:   store ptr null, ptr %9, align 8
// CHECK-NEXT:   %10 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 5
// CHECK-NEXT:   store ptr null, ptr %10, align 8
// CHECK-NEXT:   %11 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 6
// CHECK-NEXT:   store ptr %3, ptr %11, align 8
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.SetThreadDefer"(ptr %4)
// CHECK-NEXT:   %12 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 1
// CHECK-NEXT:   %13 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 3
// CHECK-NEXT:   %14 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 4
// CHECK-NEXT:   %15 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, i32 0, i32 5
...
// CHECK-NEXT:   %19 = call ptr @llvm.frameaddress.p0(i32 0)
// CHECK-NEXT:   %20 = call ptr @"{{.*}}/runtime/internal/runtime.StartRecoverFrame"(ptr %19)
// CHECK-NEXT:   %21 = call [0 x i8] @"{{.*}}/cl/_testgo/cgopython._Cfunc_Py_Finalize"()
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.EndRecoverFrame"(ptr %20)
// CHECK-NEXT:   %22 = load %"{{.*}}/runtime/internal/runtime.Defer", ptr %4, align 8
// CHECK-NEXT:   %23 = extractvalue %"{{.*}}/runtime/internal/runtime.Defer" %22, 2
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.SetThreadDefer"(ptr %23)
// CHECK-NEXT:   %24 = load ptr, ptr %14, align 8
// CHECK-NEXT:   indirectbr ptr %24, [label %_llgo_3, label %_llgo_6]
// CHECK-EMPTY:
...
// CHECK-NEXT:   %25 = call ptr @"{{.*}}/runtime/internal/runtime.CString"(%"{{.*}}/runtime/internal/runtime.String" { ptr @0, i64 23 })
// CHECK-NEXT:   %26 = call i32 @"{{.*}}/cl/_testgo/cgopython._Cfunc_PyRun_SimpleString"(ptr %25)
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgopython.main", %_llgo_6), ptr %14, align 8
// CHECK-NEXT:   br label %_llgo_2
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_5:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgopython.main", %_llgo_3), ptr %14, align 8
