...
// CHECK-LINE: @248 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
// CHECK-LINE: @249 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
// CHECK-LINE: @250 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
...
// CHECK-LABEL: define ptr @"{{.*}}/cl/_testgo/cgomacro._Cgo_ptr"(ptr %0){{.*}} {
// CHECK-NEXT: _llgo_0:
...
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgomacro.main", %_llgo_3), ptr %13, align 8
// CHECK-NEXT:   %20 = load i64, ptr %11, align 8
// CHECK-NEXT:   %21 = call [0 x i8] @"{{.*}}/cl/_testgo/cgomacro._Cfunc_Py_Finalize"()
// CHECK-NEXT:   %22 = load %"{{.*}}/runtime/internal/runtime.Defer", ptr %5, align 8
...
// CHECK-NEXT:   %24 = load ptr, ptr %15, align 8
...
// CHECK-NEXT:   %25 = call i32 @"{{.*}}/cl/_testgo/cgomacro.main$2"()
// CHECK-NEXT:   %26 = call i32 @"{{.*}}/cl/_testgo/cgomacro.main$3"()
// CHECK-NEXT:   %27 = call i32 @"{{.*}}/cl/_testgo/cgomacro.main$4"()
// CHECK-NEXT:   %28 = call i32 @"{{.*}}/cl/_testgo/cgomacro.main$5"()
// CHECK-NEXT:   %29 = call i32 @"{{.*}}/cl/_testgo/cgomacro.main$6"()
// CHECK-NEXT:   %30 = call i32 @"{{.*}}/cl/_testgo/cgomacro.main$7"()
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgomacro.main", %_llgo_6), ptr %15, align 8
// CHECK-NEXT:   br label %_llgo_2
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_5:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgomacro.main", %_llgo_3), ptr %15, align 8
// CHECK-NEXT:   %31 = load ptr, ptr %13, align 8
// CHECK-NEXT:   indirectbr ptr %31, [label %_llgo_3, label %_llgo_2]
// CHECK-EMPTY:
