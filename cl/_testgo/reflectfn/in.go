...
// CHECK-NEXT:   store { ptr, ptr } { ptr @main.demo, ptr null }, ptr %14, align 8
...
// CHECK-NEXT:   store { ptr, ptr } { ptr @main.demo, ptr null }, ptr %22, align 8
...
// CHECK-NEXT:   store { ptr, ptr } { ptr @main.demo, ptr null }, ptr %39, align 8
...
// CHECK-NEXT:   store { ptr, ptr } { ptr @main.demo, ptr null }, ptr %50, align 8
