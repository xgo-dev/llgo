...
// CHECK-NEXT:   %6 = load ptr, ptr @"{{.*}}/cl/_testgo/cgocfiles._cgo_e4a19ebb3845_Cfunc_test_structs", align 8
...
// CHECK-NEXT:   store ptr @_cgo_e4a19ebb3845_Cfunc_test_structs, ptr @"{{.*}}/cl/_testgo/cgocfiles._cgo_e4a19ebb3845_Cfunc_test_structs", align 8
