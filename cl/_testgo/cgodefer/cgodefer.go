...
// CHECK-NEXT:   %15 = icmp eq ptr %10, null
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.AssertNilDeref"(i1 %15)
// CHECK-NEXT:   %16 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %10, i32 0, i32 1
// CHECK-NEXT:   %17 = icmp eq ptr %10, null
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.AssertNilDeref"(i1 %17)
// CHECK-NEXT:   %18 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %10, i32 0, i32 3
// CHECK-NEXT:   %19 = icmp eq ptr %10, null
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.AssertNilDeref"(i1 %19)
// CHECK-NEXT:   %20 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.Defer", ptr %10, i32 0, i32 4
// CHECK-NEXT:   %21 = icmp eq ptr %10, null
...
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgodefer.main", %_llgo_3), ptr %18, align 8
// CHECK-NEXT:   %25 = load i64, ptr %16, align 8
...
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgodefer.main", %_llgo_6), ptr %20, align 8
// CHECK-NEXT:   br label %_llgo_2
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_5:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testgo/cgodefer.main", %_llgo_3), ptr %20, align 8
// CHECK-NEXT:   %33 = load ptr, ptr %18, align 8
...
// CHECK-NEXT:   call void %39(ptr %38)
// CHECK-NEXT:   br label %_llgo_8
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_8:                                          ; preds = %_llgo_7, %_llgo_2
// CHECK-NEXT:   %40 = load %"{{.*}}/runtime/internal/runtime.Defer", ptr %10, align 8
...
// CHECK-NEXT:   %42 = load ptr, ptr %20, align 8
// CHECK-NEXT:   indirectbr ptr %42, [label %_llgo_3, label %_llgo_6]
// CHECK-NEXT: }
