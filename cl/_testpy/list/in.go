...
// CHECK-LINE: @3 = private unnamed_addr constant [4 x i8] c"abs\00", align 1
// CHECK-LINE: @4 = private unnamed_addr constant [6 x i8] c"print\00", align 1
...
// CHECK-NEXT:   call void (ptr, ...) @llgoLoadPyModSyms(ptr %1, ptr @3, ptr @__llgo_py.builtins.abs, ptr @4, ptr @__llgo_py.builtins.print, ptr null)
