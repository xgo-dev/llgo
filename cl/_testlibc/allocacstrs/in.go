...
// CHECK-LINE: @2 = private unnamed_addr constant [1 x i8] c"c", align 1
// CHECK-LINE: @3 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
...
// CHECK-LABEL: define void @"{{.*}}/cl/_testlibc/allocacstrs.init"(){{.*}} {
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %0 = load i1, ptr @"{{.*}}/cl/_testlibc/allocacstrs.init$guard", align 1
// CHECK-NEXT:   br i1 %0, label %_llgo_2, label %_llgo_1
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_1:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store i1 true, ptr @"{{.*}}/cl/_testlibc/allocacstrs.init$guard", align 1
...
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.CheckIndexRange"(i1 %22, i64 %16, i1 true, i64 %19)
