...
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.PanicWrapNilPointer"(i1 %[[TMP1]], %"{{.*}}/runtime/internal/runtime.String" { ptr @[[GLOB6]], i64 43 }, %"{{.*}}/runtime/internal/runtime.String" { ptr @[[GLOB7]], i64 2 })
