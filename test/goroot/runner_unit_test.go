...
func TestObservedNotApplicableCasesAreGlobal(t *testing.T) {
	...
	cases := []testCase{
		...
		{RelPath: "nilptr5_wasm.go", Directive: "errorcheck"},
		{RelPath: "wasmmemsize.go", Directive: "runindir"},
	}
...
func TestObservedPassesDoNotHaveXFailClassifications(t *testing.T) {
	...
	tests := []struct {
		...
		{version: "go1.27.0", platform: "windows-msvc/386", tc: testCase{RelPath: "fixedbugs/bug356.go", Directive: "run"}},
		{version: "go1.27.0", platform: "windows-mingw/386", tc: testCase{RelPath: "fixedbugs/bug356.go", Directive: "run"}},
