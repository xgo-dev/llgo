...
Use source-embedded autogenerated checks only when a broad function or module
shape is itself the contract. They remain in the Go source and carry a
reproducible `UTC_ARGS` note:
