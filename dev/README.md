...
- `litgen` for the small number of source-embedded, autogenerated
...
- Generated checks abstract numeric LLVM SSA values, block suffixes, and numeric
  globals to reduce irrelevant churn.
